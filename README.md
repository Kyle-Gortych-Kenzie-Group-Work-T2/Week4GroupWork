...
<details>
  <summary>CustomerTotalSpendByTotalSpendComparator</summary>
...
public class CustomerTotalSpendByTotalSpendComparator implements Comparator<CustomerTotalSpend> {
    @Override
...
<details>
  <summary>ServiceSpendBySpendComparator</summary>
...
public class ServiceSpendBySpendComparator implements Comparator<ServiceSpend> {

    @Override
    public int compare(ServiceSpend left, ServiceSpend right) {
        int result = Long.compare(left.getSpend(),right.getSpend());
        if (result== 0){
...
<details>
  <summary>CustomerServiceSpend</summary>
...
<details>
  <summary>AwsCustomerStatistics</summary>
  
``` java
package com.kenzie.groupactivity.bigspender;

import com.kenzie.groupactivity.bigspender.compare.CustomerTotalSpendByTotalSpendComparator;
import com.kenzie.groupactivity.bigspender.compare.ServiceSpendBySpendComparator;
...
public class AwsCustomerStatistics {
    ...
    public List<CustomerServiceSpend> getTopItemizedSpends() {
        ...
        Collections.sort(totalSpends,new CustomerTotalSpendByTotalSpendComparator().reversed());
        for (CustomerTotalSpend totalSpend : totalSpends){
            ...
            Collections.sort(currentServiceSpends, new ServiceSpendBySpendComparator().reversed());
